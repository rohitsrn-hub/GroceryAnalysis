    ...
    try:
        ...
        if format == "excel":
            ...
            <body>
                ...
                <div class="section">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 15px;">
                        ...
                        <div class="metric">
                            ...
                            <div class="metric-value" style="color: {'#28a745' if monthly_insights.get('stock_value_reduction', 0) > 0 else '#dc3545'};">{format_indian_number(abs(monthly_insights.get('stock_value_reduction', 0)), currency=True, use_rs_prefix=True)}</div>
                            <div style="font-size: 12px; color: #666;">{'Decreased ✓' if monthly_insights.get('stock_value_reduction', 0) > 0 else 'Increased ↑'}</div>
                        </div>
                    </div>
                ...
                <!-- 3-MONTH TREND (Chart would be here in a full PDF generator) -->
                <div class="section">
                    ...
                    <div style="margin-top: 20px;">
                        <svg viewBox="0 0 400 200" style="width: 100%; max-width: 600px; height: auto; margin: 0 auto; display: block;">
                            ...
                            <line x1="50" y1="65" x2="380" y2="65" stroke="#ddd" stroke-width="1" stroke-dasharray="5,5"/>
                            
                            <!-- Bars for Revenue (Blue) and Profit (Green) -->
                    ...
                    <div style="overflow-x: auto;">
                        <table class="table" style="font-size: 11px;">
                            ...
                            <tr>
                                ...
                                <td><div style="background: linear-gradient(90deg, #667eea 0%, #764ba2 100%); height: 15px; width: {min(d['sales'] / (monthly_insights.get('avg_daily_sale', 1) * 2) * 100, 100)}%; border-radius: 3px;"></div></td>
                            </tr>
                            """ for d in sorted(monthly_insights.get('daily_sales_data', []), key=lambda x: x['day'])])}
                        </table>
                    </div>
                </div>
                ''' if monthly_insights else ''}
