...
const DailyUploadModal = ({ isOpen, onClose, onSuccess, lastUploadDate }) => {
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto" data-testid="daily-upload-modal">
        ...
        <div className="flex items-center justify-between p-6 border-t bg-gray-50">
          <div className="text-xs text-gray-500 font-medium text-left">
            {lastUploadDate && `Last upload: ${lastUploadDate}`}
          </div>
              ...
              {uploading ? (
                ...
                <>
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    {lastUploadDate && (
                      <span className="text-[9px] font-normal text-blue-200 opacity-80 leading-none mt-0.5">
