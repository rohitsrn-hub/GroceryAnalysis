                      ...
                      {abcAnalysis.abc_categories.A?.slice(0, 10).map((item, index) => (
                        <div key={index} className="p-3 bg-green-50 rounded-lg border border-green-200">
                          <div className="flex justify-between items-start mb-1">
                            <span className="text-xs bg-green-600 text-white px-2 py-1 rounded font-bold">#{index + 1}</span>
                          </div>
                          <p className="font-medium text-green-800 text-sm">{item.pluno} - {item.item_name}</p>
                    ...
                    <div className="space-y-3 max-h-80 overflow-y-auto">
                      {abcAnalysis.abc_categories.B?.slice(0, 10).map((item, index) => (
                        <div key={index} className="p-3 bg-blue-50 rounded-lg border border-blue-200">
                          <div className="flex justify-between items-start mb-1">
                            <span className="text-xs bg-blue-600 text-white px-2 py-1 rounded font-bold">#{index + 1}</span>
                          </div>
                          <p className="font-medium text-blue-800 text-sm">{item.pluno} - {item.item_name}</p>
                          <div className="flex justify-between items-center mt-1">
